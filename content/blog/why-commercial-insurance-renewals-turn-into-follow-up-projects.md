---
title: "Why a commercial insurance renewal turns into a follow-up project"
excerpt: "The renewal form is rarely the hard part. The real work starts when information is incomplete, last year's answers need checking, and the broker has to coordinate people across the client's business."
...
1. which questions are still open;
2. who is expected to answer each one;
3. what was answered last year;
4. what changed this year;
5. which replies are missing context;
6. which documents support an answer;
7. when the workflow needs broker judgement rather than another automated follow-up.
